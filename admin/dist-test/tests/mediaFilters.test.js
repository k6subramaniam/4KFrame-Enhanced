...
import { DEFAULT_MEDIA_FILTERS, datePresetRange, filterLibraryItems, formatBytes, } from '../src/mediaFilters.js';
...
test('date presets are inclusive calendar ranges', () => {
    assert.deepEqual(datePresetRange('last-month', new Date(2026, 8, 5, 12, 0, 0)), { startDate: '2026-08-01', endDate: '2026-08-31' });
    assert.deepEqual(datePresetRange('7-days', new Date(2026, 8, 5, 12, 0, 0)), { startDate: '2026-08-30', endDate: '2026-09-05' });
});
...
//# sourceMappingURL=mediaFilters.test.js.map